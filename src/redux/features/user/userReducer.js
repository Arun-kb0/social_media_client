import {
    ...
    GET_FOLLOWING_START, GET_FOLLOWING_SUCCESS,
    GET_NOTIFICATIONS_START, GET_NOTIFICATIONS_SUCCESS, GET_NOTIFICATIONS_FAILED,
    RECIVE_NOTIFICATION_SUCCESS, RECIVE_NOTIFICATION_FAILED, RECIVE_NOTIFICATION_START,
    REMOVE_ALL_NOTIFICATIONS_START, REMOVE_ALL_NOTIFICATIONS_SUCCESS, REMOVE_ALL_NOTIFICATIONS_FAILED,
    GET_MSG_NOTIFICATIONS_SUCCESS, REMOVE_NOTIFICATION_START, REMOVE_NOTIFICATION_SUCCESS, REMOVE_NOTIFICATION_FAILED,REMOVE_MSG_NOTIFICATIONS_SUCCESS,
    UNFOLLOW_START, UNFOLLOW_FAILED, UNFOLLOW_SUCCESS, GET_FOLLOWING_FAILED,
